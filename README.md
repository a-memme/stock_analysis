...
Once the "tickerIndex" variable was created, a set of three additional arrays were created (in addition to the tickers array), representing the values of interest when analyzing the dataset. These arrays were declared as long and single, respectively. 
...
Second, as the tickerVolumes(12) values were to be additive by default (i.e the analysis is interested in finding the total volume of each ticker), a loop was created to initialize each element in the array to begin at 0. 
