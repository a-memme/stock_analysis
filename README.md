...
The final blocks of code follwing were used to visually format the spreadhseet and were derived from the original body of code written through the modules. To see the entire finished product of refactored code, reference the Resources folder - final_refactored_code.
