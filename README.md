...
In regard to the code efficiency, the purpose of refactoring in the analysis was achieved. In the original analysis using nested loops, the code ran through the data at 1.28 seconds for the year 2017, and 1.27 seconds for the year 2018 (See below). Once refactored, the new code utilizing a number of arrays as well as an additional index variable to achieve the same tasks using only single loops, ran through the code at 0.20 seconds for the year 2017, as well as 0.20 seconds for the year 2018.
